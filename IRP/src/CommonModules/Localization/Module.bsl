...
|_________________________________________________________________________'", Lang));
	...
	Strings.Insert("S_029", NStr("en='52D2706F-223A-558A-AC2F-F9B5906B1366'", Lang));
	#EndRegion
...
|______________________________________________'", Lang));
	...
	Strings.Insert("Error_076", NStr("en='2897AB70-DADB-B465-5BE8-89288A1D7BDD____________________________________________________%1'", Lang));
...
|________________________________________________________________________________'", Lang));
	...
	Strings.Insert("QuestionToUser_009", NStr("en='7632C98A-F425-CBAE-E4D6-66C8C31F48B0______%1'", Lang));
	Strings.Insert("QuestionToUser_011", NStr("en='827DF54D-5529-3D15-5B07-7B6AF6590449___________%1'", Lang));
